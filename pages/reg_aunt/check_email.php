...
if ($_SERVER["REQUEST_METHOD"] == "POST") //проверяем как обратились к файлу если методом POST то:
{
   ...
   $email = mb_strtolower(mysqli_real_escape_string($link, clear_string($_POST['reg_email'], 'utf-8'))); //помешаем в email глобальный массив $_POST и reg_email - поле куда вводим email
